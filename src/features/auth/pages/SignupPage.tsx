// src/features/auth/pages/SignupPage.tsx
  ...
  const SignupPage = () => {
    ...
    const [currentStep, setCurrentStep] = useState(1); // 1: 필수정보, 2: 선택정보
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
          ...
          <div className="mt-6 flex justify-center items-center space-x-4">
            <div className={`flex items-center ${currentStep === 1 ? 'text-indigo-600' : 'text-gray-400'}`}>
              <span className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${currentStep === 1 ? 'bg-indigo-600 text-white' : 'bg-gray-200'}`}>1</span>
              <span className="ml-2 font-medium">필수 정보</span>
            </div>
            <svg className="w-6 h-6 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <div className={`flex items-center ${currentStep === 2 ? 'text-indigo-600' : 'text-gray-400'}`}>
              <span className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${currentStep === 2 ? 'bg-indigo-600 text-white' : 'bg-gray-200'}`}>2</span>
              <span className="ml-2 font-medium">선택 정보</span>
            </div>
          </div>
        </div>
              ...
              <form className="space-y-8" onSubmit={handleNextStep}>
                <div className="space-y-6">
                  <div className="border-b border-gray-200 pb-3">
                    <h3 className="text-lg font-semibold text-gray-900">필수 정보</h3>
                    <p className="text-sm text-gray-500 mt-1">회원가입에 필요한 기본 정보를 입력해주세요</p>
                  </div>
                ...
                {error && (
                  <div className="rounded-lg bg-red-50 p-4 border border-red-200">
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <h3 className="text-sm font-semibold text-red-800">입력 오류</h3>
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="space-y-6">
                  <div className="border-b border-gray-200 pb-3">
                    ...
                    <p className="text-sm text-gray-500 mt-1">더 나은 매칭을 위해 추가 정보를 입력해주세요</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition disabled:bg-gray-100 disabled:cursor-not-allowed"
                      >
                        <option value="">선택</option>
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="w-1/3 flex justify-center py-4 px-4 border-2 border-gray-300 rounded-lg text-base font-semibold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition"
                  >
                    ← 이전
                  </button>
                  <button
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button
                  ...
                  className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-150"
                >
                ...
                <button
                  type="button"
                  onClick={() => window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:8080'}/oauth2/authorization/naver`}
                  className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-[#03C75A] text-sm font-medium text-white hover:bg-[#02b350] transition-colors duration-150"
                >
