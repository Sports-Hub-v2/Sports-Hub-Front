...
const MyProfileInfo: React.FC = () => {
  ...
  const yn = (v?: any) =>
    String(v).toLowerCase() === "true" || String(v).toUpperCase() === "Y"
      ? "예"
      : "아니요";
  const formatDate = (dateString?: string | null) =>
    dateString ? new Date(dateString).toLocaleDateString("ko-KR") : "정보 없음";
      ...
      <div>
        ...
        <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-sm">
          ...
          <div>
            ...
            <dd className="mt-1">{fmt(profile.email)}</dd>
          </div>
          <div>
      ...
      <div>
        ...
        <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-sm">
          ...
          <div>
            ...
            <dd className="mt-1">{yn((profile as any).isExPlayer)}</dd>
          </div>
        </dl>
      </div>
